...
hkblookatmodifier::hkblookatmodifier(string filepath, string id, string preaddress, int functionlayer, bool compare)
{
	...
	address = preaddress + "zi" + to_string(functionlayer) + ">";
...
void hkblookatmodifier::nonCompare(string filepath, string id)
{
	...
	{
		cout << "ERROR: hkbLookAtModifier Outputfile(File: " << filepath << ", ID: " << id << ")" << endl;
		Error = true;
	}
...
void hkblookatmodifier::Compare(string filepath, string id)
{
	...
	if (IsOldFunction(filepath, id, address)) // is this new function or old
	{
		...
		{
			cout << "ERROR: hkbLookAtModifier Inputfile(File: " << filepath << ", newID: " << id << ", oldID: " << tempid << ")" << endl;
			Error = true;
		}
		...
		{
			cout << "ERROR: hkbLookAtModifier Outputfile(File: " << filepath << ", newID: " << id << ", oldID: " << tempid << ")" << endl;
			Error = true;
		}
...
void hkblookatmodifier::Dummy(string id)
{
	...
	{
		cout << "ERROR: Dummy hkbLookAtModifier Inputfile(File: " << filepath << ", ID: " << id << ")" << endl;
		Error = true;
	}
...
void hkbLookAtModifierExport(string originalfile, string editedfile, string id)
{
	//stage 1 reading
	...
	{
		cout << "ERROR: Edit hkbLookAtModifier Input Not Found (Original File: " << originalfile << ")" << endl;
		Error = true;
	}
	...
	{
		cout << "ERROR: Edit hkbLookAtModifier Output Not Found (Edited File: " << editedfile << ")" << endl;
		Error = true;
	}
	...
	if (IsEdited)
	{
		...
		{
			cout << "ERROR: Edit hkbLookAtModifier Output Not Found (New Edited File: " << editedfile << ")" << endl;
			Error = true;
		}
	}
	else
