...
void hkbfootikcontrolsmodifier::nonCompare(string filepath, string id)
{
	...
	{
		cout << "ERROR: hkbFootIkControlsModifier Outputfile(File: " << filepath << ", ID: " << id << ")" << endl;
		Error = true;
	}
...
void hkbfootikcontrolsmodifier::Compare(string filepath, string id)
{
	...
	if (IsOldFunction(filepath, id, address)) // is this new function or old
	{
		...
		{
			cout << "ERROR: hkbFootIkControlsModifier Inputfile(File: " << filepath << ", newID: " << id << ", oldID: " << tempid << ")" << endl;
			Error = true;
		}
		...
		{
			cout << "ERROR: hkbFootIkControlsModifier Outputfile(File: " << filepath << ", newID: " << id << ", oldID: " << tempid << ")" << endl;
			Error = true;
		}
...
void hkbfootikcontrolsmodifier::Dummy(string id)
{
	...
	{
		cout << "ERROR: Dummy hkbFootIkControlsModifier Inputfile(File: " << filepath << ", ID: " << id << ")" << endl;
		Error = true;
	}
...
void hkbFootIkControlsModifierExport(string originalfile, string editedfile, string id)
{
	//stage 1 reading
	...
	{
		cout << "ERROR: Edit hkbFootIkControlsModifier Input Not Found (Original File: " << originalfile << ")" << endl;
		Error = true;
	}
	...
	{
		cout << "ERROR: Edit hkbFootIkControlsModifier Output Not Found (Edited File: " << editedfile << ")" << endl;
		Error = true;
	}
	...
	if (IsEdited)
	{
		...
		if (outputfile.is_open())
		{
			...
			for (unsigned int i = 0; i < output.size(); i++)
			{
				...
				if (part == 0)
				{
					...
					if (output[i + 1].find("<hkparam name=\"fwdAxisLS\">", 0) != string::npos)
					{
						outputfile << output[i] << "\n";
		...
		{
			cout << "ERROR: Edit hkbFootIkControlsModi Output Not Found (New Edited File: " << editedfile << ")" << endl;
			Error = true;
		}
	}
	else
