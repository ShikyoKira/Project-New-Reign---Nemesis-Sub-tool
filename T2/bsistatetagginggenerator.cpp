...
void bsistatetagginggenerator::nonCompare(string filepath, string id)
{
	...
	{
		cout << "ERROR: BSiStateTaggingGenerator Outputfile(File: " << filepath << ", ID: " << id << ")" << endl;
		Error = true;
	}
...
void bsistatetagginggenerator::Compare(string filepath, string id)
{
	...
	if (IsOldFunction(filepath, id, address)) // is this new function or old
	{
		...
		{
			cout << "ERROR: BSiStateTaggingGenerator Inputfile(File: " << filepath << ", newID: " << id << ", oldID: " << tempid << ")" << endl;
			Error = true;
		}
		...
		{
			cout << "ERROR: BSiStateTaggingGenerator Outputfile(File: " << filepath << ", newID: " << id << ", oldID: " << tempid << ")" << endl;
			Error = true;
		}
...
void bsistatetagginggenerator::Dummy(string id)
{
	...
	{
		cout << "ERROR: Dummy BSiStateTaggingGenerator Inputfile(File: " << filepath << ", ID: " << id << ")" << endl;
		Error = true;
	}
...
void BSiStateTaggingGeneratorExport(string originalfile, string editedfile, string id)
{
	//stage 1 reading
	...
	{
		cout << "ERROR: Edit BSiStateTaggingGenerator Input Not Found (Original File: " << originalfile << ")" << endl;
		Error = true;
	}
	...
	{
		cout << "ERROR: Edit BSiStateTaggingGenerator Output Not Found (Edited File: " << editedfile << ")" << endl;
		Error = true;
	}
	...
	if (IsEdited)
	{
		...
		{
			cout << "ERROR: Edit BSiStateTaggingGenerator Output Not Found (New Edited File: " << editedfile << ")" << endl;
			Error = true;
		}
		output.close();
	}
