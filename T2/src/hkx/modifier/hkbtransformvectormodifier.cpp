...
{
	string key = "cp";
	string classname = "hkbTransformVectorModifier";
	string signature = "0xf93e0e24";
}
...
void hkbtransformvectormodifier::Compare(string filepath, string id)
{
	...
	// stage 1
	vecstr newline;
	newline.reserve(FunctionLineEdited.size());
	string line;
...
void hkbtransformvectormodifier::Dummy(string id)
{
	...
	{
		cout << "ERROR: Dummy hkbTransformVectorModifier Inputfile(ID: " << id << ")" << endl;
		Error = true;
	}
...
void hkbTransformVectorModifierExport(string id)
{
	//stage 1 reading
	...
	{
		cout << "ERROR: Edit hkbTransformVectorModifier Output Not Found (ID: " << id << ")" << endl;
		Error = true;
	}
	...
	if (IsEdited)
	{
		...
		{
			cout << "ERROR: Edit hkbTransformVectorModifier Output Not Found (File: " << filename << ")" << endl;
			Error = true;
		}
	}
	else
