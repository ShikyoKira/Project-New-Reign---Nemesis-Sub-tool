...
{
	string key = "bn";
	string classname = "hkbDelayedModifier";
	string signature = "0x8e101a7a";
}
...
void hkbdelayedmodifier::Dummy(string id)
{
	...
	{
		cout << "ERROR: Dummy hkbDelayedModifier Inputfile(ID: " << id << ")" << endl;
		Error = true;
	}
...
void hkbDelayedModifierExport(string id)
{
	//stage 1 reading
	...
	{
		cout << "ERROR: Edit hkbDelayedModifier Output Not Found (ID: " << id << ")" << endl;
		Error = true;
	}
	...
	if (IsEdited)
	{
		...
		{
			cout << "ERROR: Edit hkbDelayedModifier Output Not Found (File: " << filename << ")" << endl;
			Error = true;
		}
	}
	else
