...
{
	string key = "as";
	string classname = "hkbComputeRotationFromAxisAngleModifier";
	string signature = "0x9b3f6936";
}
...
void hkbcomputerotationfromaxisanglemodifier::Dummy(string id)
{
	...
	{
		cout << "ERROR: Dummy hkbComputeRotationFromAxisAngleModifier Inputfile(ID: " << id << ")" << endl;
		Error = true;
	}
...
void hkbComputeRotationFromAxisAngleModifierExport(string id)
{
	//stage 1 reading
	...
	{
		cout << "ERROR: Edit hkbComputeRotationFromAxisAngleModifier Output Not Found (ID: " << id << ")" << endl;
		Error = true;
	}
	...
	if (IsEdited)
	{
		...
		{
			cout << "ERROR: Edit hkbComputeRotationFromAxisAngleModifier Output Not Found (File: " << filename << ")" << endl;
			Error = true;
		}
	}
	else
