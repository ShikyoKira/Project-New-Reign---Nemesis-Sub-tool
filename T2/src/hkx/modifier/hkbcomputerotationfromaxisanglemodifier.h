...
public:
	...
	hkbcomputerotationfromaxisanglemodifier(std::string filepath, std::string id, std::string preaddress, int functionlayer, bool compare);
...
void hkbComputeRotationFromAxisAngleModifierExport(std::string id);
