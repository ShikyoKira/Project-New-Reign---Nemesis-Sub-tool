...
{
	string key = "bj";
	string classname = "BSIStateManagerModifier";
	string signature = "0x6cb24f2e";
}
...
void bsistatemanagermodifier::Dummy(string id)
{
	...
	{
		cout << "ERROR: Dummy BSIStateManagerModifier Inputfile(ID: " << id << ")" << endl;
		Error = true;
	}
...
void BSIStateManagerModifierExport(string id)
{
	//stage 1 reading
	...
	{
		cout << "ERROR: Edit BSIStateManagerModifier Output Not Found (ID: " << id << ")" << endl;
		Error = true;
	}
	...
	if (IsEdited)
	{
		...
		{
			cout << "ERROR: Edit BSIStateManagerModifier Output Not Found (File: " << filename << ")" << endl;
			Error = true;
		}
	}
	else
