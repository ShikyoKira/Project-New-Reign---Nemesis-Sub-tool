...
public:
	...
	hkbextractragdollposemodifier(std::string filepath, std::string id, std::string preaddress, int functionlayer, bool compare);
...
void hkbExtractRagdollPoseModifierExport(std::string id);
