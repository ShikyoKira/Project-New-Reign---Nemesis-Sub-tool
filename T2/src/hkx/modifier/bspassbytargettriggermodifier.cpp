...
{
	string key = "bx";
	string classname = "BSPassByTargetTriggerModifier";
	string signature = "0x703d7b66";
}
...
void bspassbytargettriggermodifier::Dummy(string id)
{
	...
	{
		cout << "ERROR: Dummy BSPassByTargetTriggerModifier Inputfile(ID: " << id << ")" << endl;
		Error = true;
	}
...
void BSPassByTargetTriggerModifierExport(string id)
{
	//stage 1 reading
	...
	{
		cout << "ERROR: Edit BSPassByTargetTriggerModifier Output Not Found (ID: " << id << ")" << endl;
		Error = true;
	}
	...
	if (IsEdited)
	{
		...
		{
			cout << "ERROR: Edit BSPassByTargetTriggerModifier Output Not Found (File: " << filename << ")" << endl;
			Error = true;
		}
	}
	else
