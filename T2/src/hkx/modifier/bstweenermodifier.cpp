...
{
	string key = "bi";
	string classname = "BSTweenerModifier";
	string signature = "0xd2d9a04";
}
...
void bstweenermodifier::Dummy(string id)
{
	...
	{
		cout << "ERROR: Dummy BSTweenerModifier Inputfile(ID: " << id << ")" << endl;
		Error = true;
	}
...
void BSTweenerModifierExport(string id)
{
	//stage 1 reading
	...
	{
		cout << "ERROR: Edit BSTweenerModifier Output Not Found (ID: " << id << ")" << endl;
		Error = true;
	}
	...
	if (IsEdited)
	{
		...
		{
			cout << "ERROR: Edit BSTweenerModifier Output Not Found (File: " << filename << ")" << endl;
			Error = true;
		}
	}
	else
