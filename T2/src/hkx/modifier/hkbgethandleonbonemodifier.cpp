...
{
	string key = "ag";
	string classname = "hkbGetHandleOnBoneModifier";
	string signature = "0x50c34a17";
}
...
void hkbgethandleonbonemodifier::Dummy(string id)
{
	...
	{
		cout << "ERROR: Dummy hkbGetHandleOnBoneModifier Inputfile(ID: " << id << ")" << endl;
		Error = true;
	}
...
void hkbGetHandleOnBoneModifierExport(string id)
{
	//stage 1 reading
	...
	{
		cout << "ERROR: Edit hkbGetHandleOnBoneModifier Output Not Found (ID: " << id << ")" << endl;
		Error = true;
	}
	...
	if (IsEdited)
	{
		...
		{
			cout << "ERROR: Edit hkbGetHandleOnBoneModifier Output Not Found (File: " << filename << ")" << endl;
			Error = true;
		}
	}
	else
