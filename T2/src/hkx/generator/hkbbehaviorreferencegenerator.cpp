...
{
	string key = "bz";
	string classname = "hkbBehaviorReferenceGenerator";
	string signature = "0xfcb5423";
}
...
void hkbbehaviorreferencegenerator::Dummy(string id)
{
	...
	{
		cout << "ERROR: Dummy hkbBehaviorReferenceGenerator Inputfile(ID: " << id << ")" << endl;
		Error = true;
	}
...
void hkbBehaviorReferenceGeneratorExport(string id)
{
	//stage 1 reading
	...
	{
		cout << "ERROR: Edit hkbBehaviorReferenceGenerator Output Not Found (ID: " << id << ")" << endl;
		Error = true;
	}
	...
	if (IsEdited)
	{
		...
		{
			cout << "ERROR: Edit hkbBehaviorReferenceGenerator Output Not Found (File: " << filename << ")" << endl;
			Error = true;
		}
	}
	else
