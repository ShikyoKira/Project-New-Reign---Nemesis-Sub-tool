...
{
	string key = "b";
	string classname = "hkbBehaviorGraphStringData";
...
{
	vecstr eventNames;
	vecstr attributeNames;
	vecstr variableNames;
	vecstr characterPropertyNames;
};

void inputGraphData(vecstr& output, vecstr orinamelist, vecstr newnamelist, bool& IsEdited, string key);
