...
hkbgetworldfrommodelmodifier::hkbgetworldfrommodelmodifier(string filepath, string id, string preaddress, int functionlayer, bool compare)
{
	...
	address = preaddress + "ak" + to_string(functionlayer) + ">";
...
void hkbgetworldfrommodelmodifier::nonCompare(string filepath, string id)
{
	...
	{
		cout << "ERROR: hkbGetWorldFromModelModifier Outputfile(File: " << filepath << ", ID: " << id << ")" << endl;
		Error = true;
	}
...
void hkbgetworldfrommodelmodifier::Compare(string filepath, string id)
{
	...
	if (IsOldFunction(filepath, id, address)) // is this new function or old
	{
		...
		{
			cout << "ERROR: hkbGetWorldFromModelModifier Inputfile(File: " << filepath << ", newID: " << id << ", oldID: " << tempid << ")" << endl;
			Error = true;
		}
		...
		{
			cout << "ERROR: hkbGetWorldFromModelModifier Outputfile(File: " << filepath << ", newID: " << id << ", oldID: " << tempid << ")" << endl;
			Error = true;
		}
...
void hkbgetworldfrommodelmodifier::Dummy(string id)
{
	...
	{
		cout << "ERROR: Dummy hkbGetWorldFromModelModifier Inputfile(File: " << filepath << ", ID: " << id << ")" << endl;
		Error = true;
	}
...
void hkbGetWorldFromModelModifierExport(string originalfile, string editedfile, string id)
{
	//stage 1 reading
	...
	{
		cout << "ERROR: Edit hkbGetWorldFromModelModifier Input Not Found (Original File: " << originalfile << ")" << endl;
		Error = true;
	}
	...
	{
		cout << "ERROR: Edit hkbGetWorldFromModelModifier Output Not Found (Edited File: " << editedfile << ")" << endl;
		Error = true;
	}
	...
	if (IsEdited)
	{
		...
		{
			cout << "ERROR: Edit hkbGetWorldFromModelModifier Output Not Found (New Edited File: " << editedfile << ")" << endl;
			Error = true;
		}
	}
	else
