...
hkbproxymodifier::hkbproxymodifier(string filepath, string id, string preaddress, int functionlayer, bool compare)
{
	...
	address = preaddress + "ai" + to_string(functionlayer) + ">";
...
void hkbproxymodifier::nonCompare(string filepath, string id)
{
	...
	{
		cout << "ERROR: hkbProxyModifier Outputfile(File: " << filepath << ", ID: " << id << ")" << endl;
		Error = true;
	}
...
void hkbproxymodifier::Compare(string filepath, string id)
{
	...
	if (IsOldFunction(filepath, id, address)) // is this new function or old
	{
		...
		{
			cout << "ERROR: hkbProxyModifier Inputfile(File: " << filepath << ", newID: " << id << ", oldID: " << tempid << ")" << endl;
			Error = true;
		}
		...
		{
			cout << "ERROR: hkbProxyModifier Outputfile(File: " << filepath << ", newID: " << id << ", oldID: " << tempid << ")" << endl;
			Error = true;
		}
...
void hkbproxymodifier::Dummy(string id)
{
	...
	{
		cout << "ERROR: Dummy hkbProxyModifier Inputfile(File: " << filepath << ", ID: " << id << ")" << endl;
		Error = true;
	}
...
void hkbProxyModifierExport(string originalfile, string editedfile, string id)
{
	//stage 1 reading
	...
	{
		cout << "ERROR: Edit hkbProxyModifier Input Not Found (Original File: " << originalfile << ")" << endl;
		Error = true;
	}
	...
	{
		cout << "ERROR: Edit hkbProxyModifier Output Not Found (Edited File: " << editedfile << ")" << endl;
		Error = true;
	}
	...
	if (IsEdited)
	{
		...
		{
			cout << "ERROR: Edit hkbProxyModifier Output Not Found (New Edited File: " << editedfile << ")" << endl;
			Error = true;
		}
	}
	else
