...
bsragdollcontactlistenermodifier::bsragdollcontactlistenermodifier(string filepath, string id, string preaddress, int functionlayer, bool compare)
{
	...
	address = preaddress + "bb" + to_string(functionlayer) + ">";
...
void bsragdollcontactlistenermodifier::nonCompare(string filepath, string id)
{
	...
	{
		cout << "ERROR: BSRagdollContactListenerModifier Outputfile(File: " << filepath << ", ID: " << id << ")" << endl;
		Error = true;
	}
...
void bsragdollcontactlistenermodifier::Compare(string filepath, string id)
{
	...
	if (IsOldFunction(filepath, id, address)) // is this new function or old
	{
		...
		{
			cout << "ERROR: BSRagdollContactListenerModifier Inputfile(File: " << filepath << ", newID: " << id << ", oldID: " << tempid << ")" << endl;
			Error = true;
		}
		...
		{
			cout << "ERROR: BSRagdollContactListenerModifier Outputfile(File: " << filepath << ", newID: " << id << ", oldID: " << tempid << ")" << endl;
			Error = true;
		}
...
void bsragdollcontactlistenermodifier::Dummy(string id)
{
	...
	{
		cout << "ERROR: Dummy BSRagdollContactListenerModifier Inputfile(File: " << filepath << ", ID: " << id << ")" << endl;
		Error = true;
	}
...
void BSRagdollContactListenerModifierExport(string originalfile, string editedfile, string id)
{
	//stage 1 reading
	...
	{
		cout << "ERROR: Edit BSRagdollContactListenerModifier Input Not Found (Original File: " << originalfile << ")" << endl;
		Error = true;
	}
	...
	{
		cout << "ERROR: Edit BSRagdollContactListenerModifier Output Not Found (Edited File: " << editedfile << ")" << endl;
		Error = true;
	}
	...
	if (IsEdited)
	{
		...
		{
			cout << "ERROR: Edit BSRagdollContactListenerModifier Output Not Found (New Edited File: " << editedfile << ")" << endl;
			Error = true;
		}
	}
	else
