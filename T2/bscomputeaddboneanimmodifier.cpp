...
bscomputeaddboneanimmodifier::bscomputeaddboneanimmodifier(string filepath, string id, string preaddress, int functionlayer, bool compare)
{
	...
	address = preaddress + "bh" + to_string(functionlayer) + ">";
...
void bscomputeaddboneanimmodifier::nonCompare(string filepath, string id)
{
	...
	{
		cout << "ERROR: BSComputeAddBoneAnimModifier Outputfile(File: " << filepath << ", ID: " << id << ")" << endl;
		Error = true;
	}
...
void bscomputeaddboneanimmodifier::Compare(string filepath, string id)
{
	...
	if (IsOldFunction(filepath, id, address)) // is this new function or old
	{
		...
		{
			cout << "ERROR: BSComputeAddBoneAnimModifier Inputfile(File: " << filepath << ", newID: " << id << ", oldID: " << tempid << ")" << endl;
			Error = true;
		}
		...
		{
			cout << "ERROR: BSComputeAddBoneAnimModifier Outputfile(File: " << filepath << ", newID: " << id << ", oldID: " << tempid << ")" << endl;
			Error = true;
		}
...
void bscomputeaddboneanimmodifier::Dummy(string id)
{
	...
	{
		cout << "ERROR: Dummy BSComputeAddBoneAnimModifier Inputfile(File: " << filepath << ", ID: " << id << ")" << endl;
		Error = true;
	}
...
void BSComputeAddBoneAnimModifierExport(string originalfile, string editedfile, string id)
{
	//stage 1 reading
	...
	{
		cout << "ERROR: Edit BSComputeAddBoneAnimModifier Input Not Found (Original File: " << originalfile << ")" << endl;
		Error = true;
	}
	...
	{
		cout << "ERROR: Edit BSComputeAddBoneAnimModifier Output Not Found (Edited File: " << editedfile << ")" << endl;
		Error = true;
	}
	...
	if (IsEdited)
	{
		...
		{
			cout << "ERROR: Edit BSComputeAddBoneAnimModifier Output Not Found (New Edited File: " << editedfile << ")" << endl;
			Error = true;
		}
	}
	else
